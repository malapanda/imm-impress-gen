...
public class SimpleCase {
	public List<MapNode> genStruct() {
		...
		final SimpleNode n11 = new SimpleNode();
		...
		final SimpleNode n12 = new SimpleNode();
		...
		final SimpleNode n111 = new SimpleNode();
		...
		final SimpleNode n21 = new SimpleNode();
		...
		return Arrays.asList((MapNode) root, (MapNode) n1, (MapNode) n11,
				(MapNode) n111, (MapNode) n12, (MapNode) n2, (MapNode) n21, (MapNode) n3);
	}
}
